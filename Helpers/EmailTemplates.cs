namespace NewsAggregation.Helpers
{
    ...
    {
        public static string IP_LOGGED_FROM_NEW_LOCATION = $@"New Login from New IP on Personal Podcast"", @""<p style=""""font-size: 16px; color: #FF0000; font-weight: bold;"""">⚠️ WARNING: SECURITY ALERT!</p>
