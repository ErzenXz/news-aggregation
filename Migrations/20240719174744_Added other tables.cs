    ...
    public partial class Addedothertables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_verifyEmails", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleStats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArticleStats_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleStats_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleStats_ArticleId",
                table: "ArticleStats",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_ArticleStats_UserId",
                table: "ArticleStats",
                column: "UserId");
